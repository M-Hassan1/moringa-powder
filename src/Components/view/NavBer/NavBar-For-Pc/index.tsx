...
import Logophoto from '@/Components/assets/images/MyLogo.png'
...
const NavBarPage = () => {
  ...
  return (
    <div className={`w-full h-[50px] md:h-[80px] backdrop-filter backdrop-blur-lg bg-slate-100/[0.25] flex items-center justify-between z-20 sticky top-0 transition-transform duration-300 ${show} `}>
        <Wrapper className='h-[60px] flex justify-between items-center ' >
          <Link href='/' > 
          <Image src={Logophoto} alt='LOGO' className='w-[80px] md:w-[100px]' />
          </Link>
